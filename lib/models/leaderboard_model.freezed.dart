...
abstract class $LeaderboardEntryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userId, String userName, int points, int rank});
}
...
class _$LeaderboardEntryImpl implements _LeaderboardEntry {
  ...
  @override
  String toString() {
    return 'LeaderboardEntry(userId: $userId, userName: $userName, points: $points, rank: $rank)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, userId, userName, points, rank);
